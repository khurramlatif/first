...
<title>World's Largest Professional Network | LinkedIn</title>
  ...
  <link rel="stylesheet" type="text/css" href="<?php  echo CSS.'/sign_up_1.css' ?>">
  <link rel="stylesheet" type="text/css" href="<?php  echo CSS.'/select/select2.css' ?>">

  <script src="<?php  echo CSS.'/select/select2.js' ?>"></script>
...
<div id="main">
	...
	<div class="progress-container">
                ...
                <h1><strong>farhan</strong>, let's start creating your professional profile</h1>
...
<li class="job-title required">
          ...
          <div class="fieldgroup"  >
            ...
            <div class="job_seeker_e1" >
            <span class="inp_error" id="workCompanyTitle-lookingProfileForm-error">Please Enter Your Most Recent Job</span>
            </div>
...
<li class="self-employed">
        ...
        <li class="company required">
              ...
              <div id="lookingProfileForm_company_ta" class="fieldgroup">
                <div class="inp_error job_seeker_e2" >
                <span  id="companyName-companyInfo-employeeCompany-lookingProfileForm-error">Please enter Most recent company</span>
                </div>
...
<li class="time-period">
      	...
      	<p class="actions">
          <span>
                <input type="submit" name="" value="Create my profile" id="employed-btn-submit" class="btn-primary" onclick="Validate()"><div class="progress-indicator" style="line-height: 16px;"></div>
          </span>
    </p>
