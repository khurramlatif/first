...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php  echo CSS.'/L_p2_css.css' ?>">
</head>
...
<div class="header-section last-child">
	...
	<ul class="nav utilities" id="control_gen_5">
...
<div id="nux-steps">
  ...
  <ol>
    ...
    <li class="step valid">
            <a href="#content-0" data-step="0">
              <span>Step 1</span> Add connections
            </a>
    </li>



      <li class=" step abook active valid ">
            <a href="#content-1">
              <span>Step 2</span> Follow influencers
            </a>
       </li>


       <li class="step last dummy">
      <a href="http://localhost/codeingniter-bootstrap/index.php/l_home_controller">See your new homepage!</a>
      </li>
...
</div>   <!-- Div with id nux-steps ends here  !-->
...
<div class="promo-head">
      <div class="nux-actions">
        ...
        <a href="http://localhost/codeingniter-bootstrap/index.php/l_home_controller">
        <input type="submit" class="nux-action main-cta" value="See your new Homepage" data-li-lego-trk-url="http://localhost/codeingniter-bootstrap/index.php/l_home_controller">
        </a>
      </div>
      
      <h2 class="promo-title">Who are 3 Influencers you'd like to hear from?</h2>

    </div>  <!-- Div with ID promo-head ends here !-->
...
<li class="promo-list-item followee-toggle">


          <span class="promo-list-item-container">
                    
                        <img src="http://m1.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/4/000/144/08a/295e054.jpg" alt="Herb Greenberg" class="person-photo" height="170" width="155">
                      
                    <span class="promo-list-item-info followee-toggle">
                      <span class="option-title">Herb Greenberg</span>
                      <span class="headline">TheStreet, CNBC</span>
                    </span>
                  </span>
...
<li class="promo-list-item followee-toggle">
          ...
          <span class="promo-list-item-container">
                        ...
                        <img src="http://m2.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/2/000/013/12c/2d78db6.jpg" alt="Herb Greenberg" class="person-photo" height="170" width="155">
...
<li class="promo-list-item followee-toggle">
          ...
          <span class="promo-list-item-container">
                        ...
                        <img src="http://m1.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/5/000/226/2a6/0824819.jpg" alt="Herb Greenberg" class="person-photo" height="170" width="155">
...
<li class="promo-list-item followee-toggle">
          ...
          <span class="promo-list-item-container">
                        ...
                        <img src="http://m2.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/6/000/1c0/385/23870f9.jpg" alt="Herb Greenberg" class="person-photo" height="170" width="155">
...
<li class="promo-list-item followee-toggle">
          ...
          <span class="promo-list-item-container">
                        ...
                        <img src="http://m1.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/2/000/195/374/1239d4f.jpg" alt="Herb Greenberg" class="person-photo" height="170" width="155">
...
<li class="promo-list-item followee-toggle">
          ...
          <span class="promo-list-item-container">
                        ...
                        <img src="http://m1.c.lnkd.licdn.com/mpr/mpr/shrink_200_200/p/3/000/053/1d1/20ceb9f.jpg" alt="Herb Greenberg" class="person-photo" height="170" width="155">
...
</div>  <!-- Div with ID promo-content ends here !-->
...
</div>    <!-- Div with ID nux-container ends here !-->
